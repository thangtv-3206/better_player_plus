...
/// Base state class with common functionality for platform-specific implementations.
abstract class BetterPlayerBaseState<T extends BetterPlayerBase> extends State<T> {
  ...
  /// Platform-specific initialization of rotation handling.
  /// Override this in Android/iOS implementations.
  @protected
  ...
  /// Platform-specific player building logic.
  /// Override this in Android/iOS implementations for platform-specific behavior.
  @protected
